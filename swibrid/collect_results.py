...
column_name_mapping = {
    ...
    "mean_length_SE":		    "read_length_SE_mean",
    "std_length_SE":		    "read_length_SE_std",
    ...
    "n_untemplated_switch_SE":	"untemplated_inserts_SE",
